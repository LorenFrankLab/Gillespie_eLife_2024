...
%save('/media/anna/whirlwindtemp2/ffresults/NFripcontent_vsctrlrats.mat','f','-v7.3')
%load('/media/anna/whirlwindtemp2/ffresults/NFripcontent_vsctrlrats.mat','f')


%% PART 1 Plot fraction of RW events that are coherent(not fragmented), fracremote, rate & # of remote replay
...
%% PART 2 Plot fraction of RW+postrw combined events that are coherent(not fragmented), local, rate & # of remote replay
clearvars -except f animals 
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
contentthresh = .3;
for a = 1:length(animals)
...
%%  PART 3 fit glm for arm categories, search+repeat combined, pre-reward
...
%%  PART 4 fit glm for arm categories, search+repeat combined, pre- + post-reward combined
clearvars -except f animals animcol
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
contentthresh = .3;
figure;  set(gcf,'Position',[90 262 1822 697]); 
...
%% PART 5 behavior comparisons: search redundancy, repeat accuracy, reaction time (trialwise)
clearvars -except f animals 
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
