%% Conditioning: Plot Decoding error during movement times 
...
%save('/media/anna/whirlwindtemp2/ffresults/cond_movementquant_full2state_all_withtrialwise.mat','f','-v7.3')
%animcol = [27 92 41; 25 123 100; 33 159 169; 123 225 191]./255;  %ctrlcols
animcol = [83 69 172; 115 101 199; 150 139 222; 190 182 240]./255;  %condcols

%load('/media/anna/whirlwindtemp2/ffresults/ctrl_movementquant_full2state_all_withtrialwise.mat')
load('/media/anna/whirlwindtemp2/ffresults/cond_movementquant_full2state_all_withtrialwise.mat')
...
for a = 1:length(animals)
    destdir = sprintf('/cumulus/anna/%s/filterframework/',animals{a});
    dayep = f(a).epochs{1};
