...
%% plot median rate & count at POSTrw, TRIALWISE comparison with lme
clearvars -except f animals
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
for a = 1:length(animals)
    if a<=4
...
%% plot median duration at POSTrw, TRIALWISE comparison with lme
clearvars -except f animals
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
figure; set(gcf,'Position',[187 1 1374 973]); hold on;
for a = 1:length(animals)
...
%% plot median rate and count at pre+POSTrw combined , TRIALWISE comparison with lme
clearvars -except f animals
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
figure; set(gcf,'Position',[187 1 1374 973]); hold on;
for a = 1:length(animals)
...
%% plot median duration at rw, TRIALWISE comparison with lme
clearvars -except f animals
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
figure; set(gcf,'Position',[187 1 1374 973]); hold on;
for a = 1:length(animals)
...
%% pre-reward riprate with velocity-matched NF vs Delay trials 
clearvars -except f animals
animcol = [123 159 242; 66 89 195; 33 42 165; 6 1 140; 254 123 123; 255 82 82; 255 0 0; 168 1 0; 148 148 148; 115 115 115; 82 82 82; 49 49 49]./255;  %ctrlcols
figure; set(gcf,'Position',[187 1 1374 973]); hold on;
for a = 1:length(animals)
...
%% raster of trigger-sizes rips on Delay trials to assess refractory period  (NF rats only)
clearvars -except f animals animcol
ratetimebin = .5;
...
%% Assess change in meanvel, dwelltime, etc in Ctrl cohort over epochs 
clearvars -except f animals animcol
figure;
    when=3;
